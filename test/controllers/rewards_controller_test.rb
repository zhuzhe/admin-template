...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { amount: @reward.amount, desc: @reward.desc, name: @reward.name, photo: @reward.photo }
    end
  ...
  test "should update reward" do
    patch :update, id: @reward, reward: { amount: @reward.amount, desc: @reward.desc, name: @reward.name, photo: @reward.photo }
    assert_redirected_to reward_path(assigns(:reward))
  end
